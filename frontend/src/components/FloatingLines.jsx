...
vec3 background_color(vec2 uv) {
  ...
  col += mix(vec3(0.184, 0.294, 0.635), BLACK, smoothstep(0.0, 1.0, abs(m)));
  col += mix(vec3(0.913, 0.278, 0.961), BLACK, smoothstep(0.0, 1.0, abs(m - 0.8)));
  return col * 0.5;
}
...
export default function FloatingLines({
  ...
  useEffect(() => {
    ...
    gradientStops.forEach((hex, i) => {
      if (i >= MAX_GRADIENT_STOPS) return;
